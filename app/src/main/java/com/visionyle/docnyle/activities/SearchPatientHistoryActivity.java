...
public class SearchPatientHistoryActivity extends AppCompatActivity implements CustomAdapter.ContactsAdapterListener{
    private static final String TAG = SearchPatientHistoryActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new CustomAdapter(this, contactList, this);

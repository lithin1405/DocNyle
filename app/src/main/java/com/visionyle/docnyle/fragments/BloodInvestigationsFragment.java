...
public class BloodInvestigationsFragment extends Fragment implements RadiologyAdapter.RemoveClickListner{
    ...
    public BloodInvestigationsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.bloodinvestigations_fragment, container, false);

...
import com.visionyle.docnyle.adapters.DiagnosticsAidsInvestigationAdapter;

import java.util.Objects;

public class DiagnosticsAidsInvestigationsFragment extends Fragment {
    TabLayout tabLayout;

    public DiagnosticsAidsInvestigationsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.diagnostics_aids_investigations_fragment, container, false);
        final ViewPager pager = view.findViewById(R.id.pager);
        assert pager != null;
        tabLayout =  view.findViewById(R.id.tabs);
        tabLayout.setupWithViewPager(pager);
        pager.setAdapter(new DiagnosticsAidsInvestigationAdapter(getChildFragmentManager()));
